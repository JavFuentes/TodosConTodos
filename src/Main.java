...
public class Main {
	...
	public static void main(String[] args) {
        ...
        while((tiempoRestante / 60) / numeroAlumnos < 8) {
			...
			System.out.println("Imposible. La cantidad de alumnos vs el tiempo no permite que la actividad se realice correctamente.");
			System.out.println("Se requiere mas tiempo o disminuir el numero de alumnos.\n");
			
			leerDatos(); 			
		}
        
        System.out.println("\nEXTREME PAIRS PROGRAMMING");
        System.out.println("----------------------------------");
        
        //Definimos el número de rondas en base a si el numero de alumnos es par o no
        ...
        //Definimos el tiempo intermedio que es igual al numero de rondas menos 1
        intercambios = rondas - 1;
       
        //Se define el largo del arreglo principal
        if(alumnosPares) {
        ...
        //TESTING - Imprime número de alumnos y tiempo restante
//        System.out.println("Numero de alumnos: " + numeroAlumnos + ". "
//                + "\nTiempo restante: " + tiempoRestante + " segundos. ");  
//        System.out.println("\nParejas unicas posibles: ");
        
        //El arreglo principal se rellena con la totalidad de los alumnos        
		...
		//Se define el largo del primer par de arreglos que contienen todas las convinaciones únicas posibles
        alumnoA = new int[parejasPosibles];
        alumnoB = new int[parejasPosibles];     
        
        //De la misma forma se define el largo que contendrá los alumnos ordenados por rondas
		...
		//Si el numero de alumnos es impar ira ubicando en cada ronda un alumno sin pareja distinto
		if(!alumnosPares) {			
		...
		//Si el número de alumnos es par ira ubicando todas las combinaciones que incluyen el 1 en una ronda distinta
		if(alumnosPares) {
						...
						for(int k = 0; k < rondas; k++) {
							for(int l = 0; l < paresPorRonda - 1; l++) {
								...
								if(alumnoA[i] == alumnoC[l + saltoRonda] || alumnoB[i] == alumnoD[l + saltoRonda] || 
										alumnoA[i] == alumnoD[l + saltoRonda] || alumnoB[i] == alumnoC[l + saltoRonda]) {
		...
		System.out.println("Intercambios: " + intercambios + 
				".\nTiempo total en intercambios: " + (tiempoTotalIntercambio / 60) + " minutos.");
